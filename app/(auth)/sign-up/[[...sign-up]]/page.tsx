    ...
    <div className="relative flex min-h-screen items-center justify-center bg-bg-primary">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="mb-8 text-center">
          <h1 className="font-display text-display-sm text-text-primary">Create your studio</h1>
          <p className="mt-2 text-text-secondary">Start generating stunning AI images today</p>
        </div>
        <SignUp />
      </div>
    </div>
